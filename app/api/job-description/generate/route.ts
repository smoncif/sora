...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Désactiver temporairement la vérification SSL pour Cloudflare tunnel
    // TODO: Remplacer par certificat Let's Encrypt sur N8N pour sécurité parfaite
    if (process.env.VERCEL === '1') {
      // @ts-ignore
      process.env.NODE_TLS_REJECT_UNAUTHORIZED = '0';
      console.log('⚠️ [SERVER] Vérification SSL désactivée (temporaire - en attente Let\'s Encrypt)');
    }
